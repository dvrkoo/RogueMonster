...
public class GameState implements Screen {
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.batch.draw(player.getTexture(), player.getBoundingRectangle().x, player.getBoundingRectangle().y,
                player.getBoundingRectangle().width, player.getBoundingRectangle().height);
        game.batch.end();
